      ...
      <v-layout row wrap>
        <v-flex xs8 offset-xs2  class="text-xs-center">
          <div class="about" >
            ...
            <span style="display: inline-block; margin-top: 20px;" > </span>
            <p class="">Acerto do vencedor com erro do placar – 1 Ponto
</p>
            <p class="">Acerto do placar – 5 pontos
</p>
            <span style="display: inline-block; margin-top: 20px;" > </span>
            ...
            <span style="display: inline-block; margin-top: 20px;" > </span>
            <p class="">Acerto de seleção classificada – 8 pontos (Independentemente da posição) </p>
            <span style="display: inline-block; margin-top: 20px;" > </span>

            <h4>Quartas de Final</h4>
            <span style="display: inline-block; margin-top: 20px;" > </span>
            <p class="">Acerto de seleção classificada – 10 pontos</p>
            <span style="display: inline-block; margin-top: 20px;" > </span>

            <h4>Semifinais</h4>
            <span style="display: inline-block; margin-top: 20px;" > </span>
            <p class="">Acerto de seleção classificada – 15 pontos</p>
            <span style="display: inline-block; margin-top: 20px;" > </span>

            <h4>Final</h4>
            <span style="display: inline-block; margin-top: 20px;" > </span>
            <p class="">Acerto de seleção classificada – 20 pontos</p>
            <span style="display: inline-block; margin-top: 20px;" > </span>
